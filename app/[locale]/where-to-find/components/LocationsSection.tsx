...
const LocationsSection = () => {
  ...
  const locationGroups = [
    ...
    },
    {
      titleKey: "pharmacy",
      partners: [
        { name: "Point Santé Pharmacy", logo: "/images/partners/Point Sante Pharmacy.jpg" },
        { name: "Aosot Plus Pharmacy", logo: "/images/partners/Aosot Plus.jpg" },
          ...
          <div key={group.titleKey} className="mb-10 sm:mb-14">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-6 gap-6 sm:gap-6">
              {group.partners.map((partner, i) => (
                <div
                  key={i} className="text-center py-5 sm:h-56 h-52">
                  <div
                  ...
                  <div className="py-1.5">
                    <span className="text-black  text-md sm:text-md mt-5 leading-tight">{partner.name}</span>
                  </div>
                </div>
              ))}
