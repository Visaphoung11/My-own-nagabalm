              ...
              <div className="p-6 border-b bg-gray-50">
                ...
                <div className="mt-2 text-sm text-gray-600">
                  Step {currentStep} of {totalSteps}: {
                    ...
                    currentStep === 2 ? "Images & Pricing" :
                    currentStep === 3 ? "English Content" : "Khmer Content"
                  }
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex">
                          <div className="ml-3">
                            <p className="text-sm text-blue-700">
                              <strong>Step 1:</strong> Let's start with the basic product information. 
                              Fill in the product name first, and we'll help generate a URL-friendly slug for you.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            This will be the main product name displayed to customers
                          </p>
                        </div>
                        ...
                        <div>
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            URL-friendly version (auto-generated from name, but you can edit)
                          </p>
                        </div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  en: { ...form.translations.en, size: e.target.value }
                                }
                              })
                            }
                            className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-orange-500 focus:outline-none"
                        ...
                        <div className="flex">
                          <div className="ml-3">
                            <p className="text-sm text-green-700">
                              <strong>Step 2:</strong> Add product images and set the price. 
                              Good product images help customers make purchase decisions.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <label className="cursor-pointer">
                              <div className="space-y-2">
                                ...
                                <div className="text-gray-600">
                                  <span className="font-medium text-orange-600">Click to upload images</span> or drag and drop
                                </div>
                        ...
                        <div className="flex items-start space-x-3 pt-8">
                          <input
                            ...
                            type="checkbox"
                            checked={form.isTopSell}
                            onChange={(e) => setForm({ ...form, isTopSell: e.target.checked })}
                            className="w-4 h-4 text-orange-600 bg-gray-100 border-gray-300 rounded focus:ring-orange-500"
                          />
                          <div>
                            <label htmlFor="isTopSell" className="text-sm font-medium text-gray-700">
                              Mark as Top Selling Product
                            </label>
                            <p className="text-xs text-gray-500">
                              Top selling products get featured placement on the website
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                        ...
                        <div className="flex">
                          <div className="ml-3">
                            <p className="text-sm text-purple-700">
                              <strong>Step 3:</strong> Add detailed product information in English. 
                              This content will be shown to English-speaking customers.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div>
                          <label htmlFor="desc-en" className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  en: { ...form.translations.en, description: e.target.value }
                                }
                              })
                            }
                            rows={5}
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Write a compelling description that highlights the product benefits
                          </p>
                        </div>

                        <div>
                          <label htmlFor="ingredient-en" className="block text-sm font-medium text-gray-700 mb-2">
                            Active Ingredients
                          </label>
                          <textarea
                            id="ingredient-en"
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  en: { ...form.translations.en, activeIngredient: e.target.value }
                                }
                              })
                            }
                            rows={4}
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            List key ingredients that make this product effective
                          </p>
                        </div>

                        <div>
                          <label htmlFor="usage-en" className="block text-sm font-medium text-gray-700 mb-2">
                            How to Use
                          </label>
                          <textarea
                            id="usage-en"
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            Write each usage instruction on a new line. Press Enter to start a new line.
                          </p>
                        </div>

                        <div>
                          <label htmlFor="tags-en" className="block text-sm font-medium text-gray-700 mb-2">
                            Best For (Tags)
                          </label>
                          <input
                            id="tags-en"
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...
                                  en: {
                                    ...form.translations.en,
                                    bestForTags: e.target.value.split(",").map(s => s.trim()).filter(Boolean)
                                  }
                                }
                              })
                            }
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6">
                        ...
                        <div className="flex">
                          <div className="ml-3">
                            <p className="text-sm text-yellow-700">
                              <strong>Step 4:</strong> Add the same product information in Khmer language. 
                              This content will be shown to Khmer-speaking customers.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-6">
                        <div>
                          <label htmlFor="name-km" className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  km: { ...form.translations.km, name: e.target.value }
                                }
                              })
                            }
                            className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-orange-500 focus:outline-none"
                        ...
                        <div>
                          <label htmlFor="size-km" className="block text-sm font-medium text-gray-700 mb-2">
                            Product Size (Khmer)
                          </label>
                          <input
                            id="size-km"
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  km: { ...form.translations.km, size: e.target.value }
                                }
                              })
                            }
                            className="w-full border-2 border-gray-200 rounded-lg px-4 py-3 focus:border-orange-500 focus:outline-none"
                        ...
                        <div>
                          <label htmlFor="desc-km" className="block text-sm font-medium text-gray-700 mb-2">
                            Product Description (Khmer) <span className="text-red-500">*</span>
                          </label>
                          <textarea
                            id="desc-km"
                            required
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  km: { ...form.translations.km, description: e.target.value }
                                }
                              })
                            }
                            rows={5}
                        ...
                        <div>
                          <label htmlFor="ingredient-km" className="block text-sm font-medium text-gray-700 mb-2">
                          ...
                          <textarea
                            ...
                            onChange={(e) =>
                              setForm({
                                ...
                                translations: {
                                  ...form.translations,
                                  km: { ...form.translations.km, activeIngredient: e.target.value }
                                }
                              })
                            }
                            rows={4}
                        ...
                        <div>
                          <label htmlFor="usage-km" className="block text-sm font-medium text-gray-700 mb-2">
                            How to Use (Khmer)
                          </label>
                          <textarea
                            id="usage-km"
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            សរសេរការណែនាំការប្រើប្រាស់នីមួយៗនៅលើបន្ទាត់ថ្មី។ ចុច Enter ដើម្បីចាប់ផ្តើមបន្ទាត់ថ្មី។
                          </p>
                        </div>

                        <div>
                          <label htmlFor="tags-km" className="block text-sm font-medium text-gray-700 mb-2">
                            Best For Tags (Khmer)
                          </label>
                          <input
                            id="tags-km"
                          ...
                          />
                          <p className="text-xs text-gray-500 mt-1">
                            បំបែកស្លាកដោយសញ្ញាក្បៀស។ ស្លាកទាំងនេះជួយអតិថិជនរកឃើញផលិតផលរបស់អ្នក។
                          </p>
                        </div>
                      </div>
                    </div>
