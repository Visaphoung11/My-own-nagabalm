...
// //                 {/* Image Container */}
// //                 <div
// //                   className={`card relative aspect-square mb-4 sm:mb-6 bg-white overflow-hidden`}
// //                 >
// //                   {/* Product Image */}
...
// //                     </h3>
// //                     <span
// //                       className={`text-xs sm:text-sm font-bold opacity-75 ${
// //                         locale === "km" ? "font-hanuman" : ""
// //                       }`}
// //                     >
...
// //                   </div>
// //                   <p
// //                     className={`text-sm text-black mb-3 sm:mb-4 min-h-[40px] sm:min-h-[48px] ${
// //                       locale === "km" ? "font-hanuman" : ""
// //                     }`}
// //                   >
